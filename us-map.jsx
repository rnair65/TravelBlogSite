...
const USMap = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 flex items-center justify-center p-4 sm:p-8 font-sans">
      <style>{`
        ...
        .scanline {
          ...
          width: 100%;
          height: 2px;
          background: linear-gradient(transparent, rgba(168, 85, 247, 0.3), transparent);
      ...
      <div className="w-full max-w-7xl">
        <div className="text-center mb-8 fade-in-up">
          <h1 className="text-4xl sm:text-6xl font-black mb-3 glow-text" style={{ fontFamily: 'Orbitron, sans-serif', letterSpacing: '0.1em' }}>
            UNITED STATES
          </h1>
          <p className="text-purple-300 text-base sm:text-lg" style={{ fontFamily: 'Space Mono, monospace' }}>
            Click any state to explore
          </p>
        </div>

        <div className="relative bg-slate-950/50 rounded-3xl p-4 sm:p-8 backdrop-blur-sm border border-purple-500/30 map-container grid-bg">
          ...
          <div className="relative">
            ...
            >
              <path
                className={`state-path ${selectedState === 'MA' ? 'selected' : ''}`}
                ...
                fill={hoveredState === 'MA' || selectedState === 'MA' ? '#ec4899' : '#a855f7'}
                stroke="#0f172a"
                strokeWidth="0.5"
              />
              <path
                className={`state-path ${selectedState === 'MN' ? 'selected' : ''}`}
                ...
                fill={hoveredState === 'MN' || selectedState === 'MN' ? '#ec4899' : '#a855f7'}
                stroke="#0f172a"
                strokeWidth="0.5"
              />
              <path
                className={`state-path ${selectedState === 'MT' ? 'selected' : ''}`}
                ...
                fill={hoveredState === 'MT' || selectedState === 'MT' ? '#ec4899' : '#a855f7'}
                stroke="#0f172a"
                strokeWidth="0.5"
              />
              <path
                className={`state-path ${selectedState === 'ND' ? 'selected' : ''}`}
                onClick={() => handleStateClick('ND')}
                onMouseEnter={() => handleStateHover('ND')}
                onMouseLeave={handleStateLeave}
                id="ND"
                ...
                fill={hoveredState === 'ND' || selectedState === 'ND' ? '#ec4899' : '#a855f7'}
                stroke="#0f172a"
                strokeWidth="0.5"
              />
              <path
                className={`state-path ${selectedState === 'HI' ? 'selected' : ''}`}
                ...
                fill={hoveredState === 'HI' || selectedState === 'HI' ? '#ec4899' : '#a855f7'}
                stroke="#0f172a"
                strokeWidth="0.5"
              />
              <path
                className={`state-path ${selectedState === 'ID' ? 'selected' : ''}`}
                ...
                fill={hoveredState === 'ID' || selectedState === 'ID' ? '#ec4899' : '#a855f7'}
                stroke="#0f172a"
                strokeWidth="0.5"
              />
              <path
                className={`state-path ${selectedState === 'WA' ? 'selected' : ''}`}
                ...
                fill={hoveredState === 'WA' || selectedState === 'WA' ? '#ec4899' : '#a855f7'}
                stroke="#0f172a"
                strokeWidth="0.5"
              />
              <path
                className={`state-path ${selectedState === 'AZ' ? 'selected' : ''}`}
                onClick={() => handleStateClick('AZ')}
                onMouseEnter={() => handleStateHover('AZ')}
                onMouseLeave={handleStateLeave}
                id="AZ"
                ...
                fill={hoveredState === 'AZ' || selectedState === 'AZ' ? '#ec4899' : '#a855f7'}
                stroke="#0f172a"
                strokeWidth="0.5"
              />
              <path
                className={`state-path ${selectedState === 'CA' ? 'selected' : ''}`}
                ...
                fill={hoveredState === 'CA' || selectedState === 'CA' ? '#ec4899' : '#a855f7'}
                stroke="#0f172a"
                strokeWidth="0.5"
              />
              <path
                className={`state-path ${selectedState === 'CO' ? 'selected' : ''}`}
                ...
                fill={hoveredState === 'CO' || selectedState === 'CO' ? '#ec4899' : '#a855f7'}
                stroke="#0f172a"
                strokeWidth="0.5"
              />
              <path
                className={`state-path ${selectedState === 'NV' ? 'selected' : ''}`}
                onClick={() => handleStateClick('NV')}
                onMouseEnter={() => handleStateHover('NV')}
                onMouseLeave={handleStateLeave}
                id="NV"
                ...
                fill={hoveredState === 'NV' || selectedState === 'NV' ? '#ec4899' : '#a855f7'}
                stroke="#0f172a"
                strokeWidth="0.5"
              />
              <path
                className={`state-path ${selectedState === 'NM' ? 'selected' : ''}`}
                onClick={() => handleStateClick('NM')}
                onMouseEnter={() => handleStateHover('NM')}
                onMouseLeave={handleStateLeave}
                id="NM"
                ...
                fill={hoveredState === 'NM' || selectedState === 'NM' ? '#ec4899' : '#a855f7'}
                stroke="#0f172a"
                strokeWidth="0.5"
              />
              <path
                className={`state-path ${selectedState === 'OR' ? 'selected' : ''}`}
                ...
                fill={hoveredState === 'OR' || selectedState === 'OR' ? '#ec4899' : '#a855f7'}
                stroke="#0f172a"
                strokeWidth="0.5"
              />
              <path
                className={`state-path ${selectedState === 'UT' ? 'selected' : ''}`}
                onClick={() => handleStateClick('UT')}
                onMouseEnter={() => handleStateHover('UT')}
                onMouseLeave={handleStateLeave}
                id="UT"
                ...
                fill={hoveredState === 'UT' || selectedState === 'UT' ? '#ec4899' : '#a855f7'}
                stroke="#0f172a"
                strokeWidth="0.5"
              />
              <path
                className={`state-path ${selectedState === 'WY' ? 'selected' : ''}`}
                onClick={() => handleStateClick('WY')}
                onMouseEnter={() => handleStateHover('WY')}
                onMouseLeave={handleStateLeave}
                id="WY"
                ...
                fill={hoveredState === 'WY' || selectedState === 'WY' ? '#ec4899' : '#a855f7'}
                stroke="#0f172a"
                strokeWidth="0.5"
              />
              <path
                className={`state-path ${selectedState === 'AR' ? 'selected' : ''}`}
                ...
                fill={hoveredState === 'AR' || selectedState === 'AR' ? '#ec4899' : '#a855f7'}
                stroke="#0f172a"
                strokeWidth="0.5"
              />
              <path
                className={`state-path ${selectedState === 'IA' ? 'selected' : ''}`}
                onClick={() => handleStateClick('IA')}
                onMouseEnter={() => handleStateHover('IA')}
                onMouseLeave={handleStateLeave}
                id="IA"
                ...
                fill={hoveredState === 'IA' || selectedState === 'IA' ? '#ec4899' : '#a855f7'}
                stroke="#0f172a"
                strokeWidth="0.5"
              />
              <path
                className={`state-path ${selectedState === 'KS' ? 'selected' : ''}`}
                onClick={() => handleStateClick('KS')}
                onMouseEnter={() => handleStateHover('KS')}
                onMouseLeave={handleStateLeave}
                id="KS"
                ...
                fill={hoveredState === 'KS' || selectedState === 'KS' ? '#ec4899' : '#a855f7'}
                stroke="#0f172a"
                strokeWidth="0.5"
              />
              <path
                className={`state-path ${selectedState === 'MO' ? 'selected' : ''}`}
                onClick={() => handleStateClick('MO')}
                onMouseEnter={() => handleStateHover('MO')}
                onMouseLeave={handleStateLeave}
                id="MO"
                ...
                fill={hoveredState === 'MO' || selectedState === 'MO' ? '#ec4899' : '#a855f7'}
                stroke="#0f172a"
                strokeWidth="0.5"
              />
              <path
                className={`state-path ${selectedState === 'NE' ? 'selected' : ''}`}
                onClick={() => handleStateClick('NE')}
                onMouseEnter={() => handleStateHover('NE')}
                onMouseLeave={handleStateLeave}
                id="NE"
                ...
                fill={hoveredState === 'NE' || selectedState === 'NE' ? '#ec4899' : '#a855f7'}
                stroke="#0f172a"
                strokeWidth="0.5"
              />
              <path
                className={`state-path ${selectedState === 'OK' ? 'selected' : ''}`}
                onClick={() => handleStateClick('OK')}
                onMouseEnter={() => handleStateHover('OK')}
                onMouseLeave={handleStateLeave}
                id="OK"
                ...
                fill={hoveredState === 'OK' || selectedState === 'OK' ? '#ec4899' : '#a855f7'}
                stroke="#0f172a"
                strokeWidth="0.5"
              />
              <path
                className={`state-path ${selectedState === 'SD' ? 'selected' : ''}`}
                onClick={() => handleStateClick('SD')}
                onMouseEnter={() => handleStateHover('SD')}
                onMouseLeave={handleStateLeave}
                id="SD"
                ...
                fill={hoveredState === 'SD' || selectedState === 'SD' ? '#ec4899' : '#a855f7'}
                stroke="#0f172a"
                strokeWidth="0.5"
              />
              <path
                className={`state-path ${selectedState === 'LA' ? 'selected' : ''}`}
                onClick={() => handleStateClick('LA')}
                onMouseEnter={() => handleStateHover('LA')}
                onMouseLeave={handleStateLeave}
                id="LA"
                ...
                fill={hoveredState === 'LA' || selectedState === 'LA' ? '#ec4899' : '#a855f7'}
                stroke="#0f172a"
                strokeWidth="0.5"
              />
              <path
                className={`state-path ${selectedState === 'TX' ? 'selected' : ''}`}
                ...
                fill={hoveredState === 'TX' || selectedState === 'TX' ? '#ec4899' : '#a855f7'}
                stroke="#0f172a"
                strokeWidth="0.5"
              />
              <path
                className={`state-path ${selectedState === 'CT' ? 'selected' : ''}`}
                ...
                fill={hoveredState === 'CT' || selectedState === 'CT' ? '#ec4899' : '#a855f7'}
                stroke="#0f172a"
                strokeWidth="0.5"
              />
              <path
                className={`state-path ${selectedState === 'NH' ? 'selected' : ''}`}
                ...
                fill={hoveredState === 'NH' || selectedState === 'NH' ? '#ec4899' : '#a855f7'}
                stroke="#0f172a"
                strokeWidth="0.5"
              />
              <path
                className={`state-path ${selectedState === 'RI' ? 'selected' : ''}`}
                ...
                fill={hoveredState === 'RI' || selectedState === 'RI' ? '#ec4899' : '#a855f7'}
                stroke="#0f172a"
                strokeWidth="0.5"
              />
              <path
                className={`state-path ${selectedState === 'VT' ? 'selected' : ''}`}
                ...
                fill={hoveredState === 'VT' || selectedState === 'VT' ? '#ec4899' : '#a855f7'}
                stroke="#0f172a"
                strokeWidth="0.5"
              />
              <path
                className={`state-path ${selectedState === 'AL' ? 'selected' : ''}`}
                ...
                fill={hoveredState === 'AL' || selectedState === 'AL' ? '#ec4899' : '#a855f7'}
                stroke="#0f172a"
                strokeWidth="0.5"
              />
              <path
                className={`state-path ${selectedState === 'FL' ? 'selected' : ''}`}
                ...
                fill={hoveredState === 'FL' || selectedState === 'FL' ? '#ec4899' : '#a855f7'}
                stroke="#0f172a"
                strokeWidth="0.5"
              />
              <path
                className={`state-path ${selectedState === 'GA' ? 'selected' : ''}`}
                ...
                fill={hoveredState === 'GA' || selectedState === 'GA' ? '#ec4899' : '#a855f7'}
                stroke="#0f172a"
                strokeWidth="0.5"
              />
              <path
                className={`state-path ${selectedState === 'MS' ? 'selected' : ''}`}
                ...
                fill={hoveredState === 'MS' || selectedState === 'MS' ? '#ec4899' : '#a855f7'}
                stroke="#0f172a"
                strokeWidth="0.5"
              />
              <path
                className={`state-path ${selectedState === 'SC' ? 'selected' : ''}`}
                ...
                fill={hoveredState === 'SC' || selectedState === 'SC' ? '#ec4899' : '#a855f7'}
                stroke="#0f172a"
                strokeWidth="0.5"
              />
              <path
                className={`state-path ${selectedState === 'IL' ? 'selected' : ''}`}
                onClick={() => handleStateClick('IL')}
                onMouseEnter={() => handleStateHover('IL')}
                onMouseLeave={handleStateLeave}
                id="IL"
                ...
                fill={hoveredState === 'IL' || selectedState === 'IL' ? '#ec4899' : '#a855f7'}
                stroke="#0f172a"
                strokeWidth="0.5"
              />
              <path
                className={`state-path ${selectedState === 'IN' ? 'selected' : ''}`}
                onClick={() => handleStateClick('IN')}
                onMouseEnter={() => handleStateHover('IN')}
                onMouseLeave={handleStateLeave}
                id="IN"
                ...
                fill={hoveredState === 'IN' || selectedState === 'IN' ? '#ec4899' : '#a855f7'}
                stroke="#0f172a"
                strokeWidth="0.5"
              />
              <path
                className={`state-path ${selectedState === 'KY' ? 'selected' : ''}`}
                ...
                fill={hoveredState === 'KY' || selectedState === 'KY' ? '#ec4899' : '#a855f7'}
                stroke="#0f172a"
                strokeWidth="0.5"
              />
              <path
                className={`state-path ${selectedState === 'NC' ? 'selected' : ''}`}
                ...
                fill={hoveredState === 'NC' || selectedState === 'NC' ? '#ec4899' : '#a855f7'}
                stroke="#0f172a"
                strokeWidth="0.5"
              />
              <path
                className={`state-path ${selectedState === 'OH' ? 'selected' : ''}`}
                ...
                fill={hoveredState === 'OH' || selectedState === 'OH' ? '#ec4899' : '#a855f7'}
                stroke="#0f172a"
                strokeWidth="0.5"
              />
              <path
                className={`state-path ${selectedState === 'TN' ? 'selected' : ''}`}
                ...
                fill={hoveredState === 'TN' || selectedState === 'TN' ? '#ec4899' : '#a855f7'}
                stroke="#0f172a"
                strokeWidth="0.5"
              />
              <path
                className={`state-path ${selectedState === 'VA' ? 'selected' : ''}`}
                onClick={() => handleStateClick('VA')}
                onMouseEnter={() => handleStateHover('VA')}
                onMouseLeave={handleStateLeave}
                id="VA"
                ...
                fill={hoveredState === 'VA' || selectedState === 'VA' ? '#ec4899' : '#a855f7'}
                stroke="#0f172a"
                strokeWidth="0.5"
              />
              <path
                className={`state-path ${selectedState === 'WI' ? 'selected' : ''}`}
                onClick={() => handleStateClick('WI')}
                onMouseEnter={() => handleStateHover('WI')}
                onMouseLeave={handleStateLeave}
                id="WI"
                ...
                fill={hoveredState === 'WI' || selectedState === 'WI' ? '#ec4899' : '#a855f7'}
                stroke="#0f172a"
                strokeWidth="0.5"
              />
              <path
                className={`state-path ${selectedState === 'WV' ? 'selected' : ''}`}
                ...
                fill={hoveredState === 'WV' || selectedState === 'WV' ? '#ec4899' : '#a855f7'}
                stroke="#0f172a"
                strokeWidth="0.5"
              />
              <path
                className={`state-path ${selectedState === 'DE' ? 'selected' : ''}`}
                ...
                fill={hoveredState === 'DE' || selectedState === 'DE' ? '#ec4899' : '#a855f7'}
                stroke="#0f172a"
                strokeWidth="0.5"
              />
              <path
                className={`state-path ${selectedState === 'DC' ? 'selected' : ''}`}
                ...
                fill={hoveredState === 'DC' || selectedState === 'DC' ? '#ec4899' : '#a855f7'}
                stroke="#0f172a"
                strokeWidth="0.5"
              />
              <path
                className={`state-path ${selectedState === 'MD' ? 'selected' : ''}`}
                ...
                fill={hoveredState === 'MD' || selectedState === 'MD' ? '#ec4899' : '#a855f7'}
                stroke="#0f172a"
                strokeWidth="0.5"
              />
              <path
                className={`state-path ${selectedState === 'NJ' ? 'selected' : ''}`}
                ...
                fill={hoveredState === 'NJ' || selectedState === 'NJ' ? '#ec4899' : '#a855f7'}
                stroke="#0f172a"
                strokeWidth="0.5"
              />
              <path
                className={`state-path ${selectedState === 'NY' ? 'selected' : ''}`}
                ...
                fill={hoveredState === 'NY' || selectedState === 'NY' ? '#ec4899' : '#a855f7'}
                stroke="#0f172a"
                strokeWidth="0.5"
              />
              <path
                className={`state-path ${selectedState === 'PA' ? 'selected' : ''}`}
                ...
                fill={hoveredState === 'PA' || selectedState === 'PA' ? '#ec4899' : '#a855f7'}
                stroke="#0f172a"
                strokeWidth="0.5"
              />
              <path
                className={`state-path ${selectedState === 'ME' ? 'selected' : ''}`}
                ...
                fill={hoveredState === 'ME' || selectedState === 'ME' ? '#ec4899' : '#a855f7'}
                stroke="#0f172a"
                strokeWidth="0.5"
              />
              <path
                className={`state-path ${selectedState === 'MI' ? 'selected' : ''}`}
                ...
                fill={hoveredState === 'MI' || selectedState === 'MI' ? '#ec4899' : '#a855f7'}
                stroke="#0f172a"
                strokeWidth="0.5"
              />
              <path
                className={`state-path ${selectedState === 'AK' ? 'selected' : ''}`}
                ...
                fill={hoveredState === 'AK' || selectedState === 'AK' ? '#ec4899' : '#a855f7'}
                stroke="#0f172a"
                strokeWidth="0.5"
              />            </svg>
          </div>
          ...
          {(hoveredState || selectedState) && (
            <div className="mt-8 text-center fade-in-up">
              <div className="inline-block bg-gradient-to-r from-purple-600 to-pink-600 rounded-2xl px-6 sm:px-8 py-4 shadow-lg shadow-purple-500/50">
                <p className="text-xs sm:text-sm text-purple-200 mb-1" style={{ fontFamily: 'Space Mono, monospace' }}>
                  {selectedState ? 'SELECTED' : 'HOVER'}
                </p>
                <h2 className="text-2xl sm:text-3xl font-bold text-white" style={{ fontFamily: 'Orbitron, sans-serif' }}>
                  {stateNames[hoveredState || selectedState]}
                </h2>
                <p className="text-base sm:text-lg text-purple-100 mt-1" style={{ fontFamily: 'Space Mono, monospace' }}>
                  {hoveredState || selectedState}
                </p>
              </div>
            </div>
        ...
        <div className="mt-6 text-center text-purple-400 text-xs sm:text-sm" style={{ fontFamily: 'Space Mono, monospace' }}>
          {selectedState ? 
            'Click another state or click the same state again to deselect' : 
